...
class ARM_A9_L1_Cache(Cache):
    ...
    def __init__(self, options=None):
        super(ARM_A9_L1_Cache, self).__init__()
        pass
...
class ARM_A9_L2_Cache(Cache):
    ...
    def __init__(self, options=None):
        super(ARM_A9_L2_Cache, self).__init__()
        pass
...
class A9_System(System):

    def __init__(self, options=None):
        super(A9_System, self).__init__()
...
############################################################
        self.cpu.icache  = ARM_A9_L1_Cache()
        self.cpu.dcache  = ARM_A9_L1_Cache()
        self.cpu.l2cache = ARM_A9_L2_Cache()
