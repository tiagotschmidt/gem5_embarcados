...
def main():
    ...
    for filename in os.listdir():
        if filename.startswith("game_of_life_medium_") and filename.endswith(".txt"):
    ...
    with open("medium_game_of_life_statistics.txt", 'w') as f:
    ...
    print("Statistics saved to medium_game_of_life_statistics.txt")
