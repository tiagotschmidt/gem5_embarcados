...
def main():
    ...
    for filename in os.listdir():
        if filename.startswith("large_haar_") and filename.endswith(".txt"):
    ...
    with open("large_haar_statistics.txt", 'w') as f:
    ...
    print("Statistics saved to large_haar_statistics.txt")
