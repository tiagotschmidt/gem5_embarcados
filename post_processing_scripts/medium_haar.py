...
def main():
    ...
    for filename in os.listdir():
        if filename.startswith("medium_haar_") and filename.endswith(".txt"):
    ...
    with open("medium_haar_statistics.txt", 'w') as f:
    ...
    print("Statistics saved to medium_haar_statistics.txt")
