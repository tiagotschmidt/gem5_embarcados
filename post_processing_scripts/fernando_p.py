...
def main():
    ...
    for filename in os.listdir():
        if filename.startswith("fernando_p_") and filename.endswith(".txt"):
    ...
    with open("fernando_p_statistics.txt", 'w') as f:
    ...
    print("Statistics saved to fernando_p_statistics.txt")
