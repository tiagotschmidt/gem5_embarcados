...
def main():
    ...
    for filename in os.listdir():
        if filename.startswith("small_haar_") and filename.endswith(".txt"):
    ...
    with open("small_haar_statistics.txt", 'w') as f:
    ...
    print("Statistics saved to small_haar_statistics.txt")
