...
def main():
    ...
    for filename in os.listdir():
        if filename.startswith("hello_world_") and filename.endswith(".txt"):
    ...
    with open("hello_world_statistics.txt", 'w') as f:
    ...
    print("Statistics saved to hello_world_statistics.txt")
