...
def plot_data():
    ...
    """
    versions = ["small_game", "medium_game", "large_game"]
...
read_data("small_game_of_life_statistics.txt")
read_data("medium_game_of_life_statistics.txt")
read_data("large_game_of_life_statistics.txt")
