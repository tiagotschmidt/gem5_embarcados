...
def plot_data():
    ...
    """
    versions = ["hello_world", "fernando_p", "frankenstein"]
...
read_data("hello_world_statistics.txt")
read_data("fernando_p_statistics.txt")
read_data("frankenstein_statistics.txt")
